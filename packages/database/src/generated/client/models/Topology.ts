...
// @ts-nocheck 
/*
 * This file exports the `Topology` model and its related types.
 *
...
export type GetTopologyAggregateType<T extends TopologyAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTopology[P]>
    : Prisma.GetScalarType<T[P], AggregateTopology[P]>
}
...
export type GetTopologyGroupByPayload<T extends TopologyGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<TopologyGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof TopologyGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], TopologyGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], TopologyGroupByOutputType[P]>
      }
    >
  >
...
export type TopologyCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface TopologyDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends TopologyCountArgs>(
    args?: Prisma.Subset<T, TopologyCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], TopologyCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, TopologyGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTopologyGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
